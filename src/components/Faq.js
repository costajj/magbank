...
//             </Col>
//             <Col className='d-none d-lg-block'>
//                 <IconText icon={faCreditCard} size={3}>Debit and Credit Card</IconText>
//                 <IconText icon={faWallet} size={3}>Opening Account</IconText>
//                 <IconText icon={faShieldAlt} size={3}>Digital Token</IconText>
//                 <IconText icon={faUserTie} size={3}>Services and Products</IconText>
//             </Col>
//             <Col>
//             </Col>
//         </Row>
